    ...
    def train(self):
        ...
        for e in range(self.train_config['epochs']):
            for didx, train_data in enumerate(self.data['train']):
                ...
                loss = self.model.cross_attn.get_train_loss(residual_embed, train_graph.ndata['ano_labels'],
        ...
        for didx, test_data in enumerate(self.data['test']):
            ...
            labels = test_graph.ndata['ano_labels']
